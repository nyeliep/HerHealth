...
// import {MdLocalHospital} from "react-dom/md";
...
const Dashboard = ()=>{
    ...
    return(
        <>
            ...
            <title>{`HerHealthHub | ${CurrentUser?.displayName} Dashboard`}</title>
               {/* {Dashboard} */}
        <div className="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
            ...
            >
                <div className="container-fluid">
                    ...
                    aria-aria-controls="sidebarCollapse"
                    aria-expanded="false"
                        ...
                        <div className="dropdown">
                            ...
                            aria-expanded="false">
                             ...
                             <div className="avatar-parent-child">
                                ...
                                />
                                <span className="avatar-child avatar-badge bg-succes"></span>
                                </div>   
                            </a>
                            {/* menu */}
                            <div
                            ...
                            >
                                ...
                                <Link to="/blogform" className="dropdown-item">Blogs</Link>
                        ...
                        <ul className="navbar-nav mb-md-4">
                            ...
                            <li>
                                <a href="#" className="nav-link d-flex align-items-center">
                                    <div className="me-4">
                                        <div className="position-absolute bottom-2 end-2 transform translate-x-1/2 translate-y-1/2 border-2 border-solid border-current w-3 h-3 bg-success rounded-circle">
                                            <img 
                                            src=""
                                            alt="image"
                    ...
                    <div className="mb-npx">
                        <div className="row align-items-center">
                            <div className="col-sm-6 col-12 mb-4 mb-sm-0">
                                ...
                                style={{color: "#5C60F5"}}
                                >
                                    {`Hello, ${CurrentUser?.displayName?.toLowerCase()}`}
                                </h1>
                            </div>
                        ...
                        {/* nav */}
                        <ul className="nav nav-tabs mt-4 overflcol-sm-6 col-12 mb-4 mb-sm-0ow-x border-0">
                            <li className="nav-item">
